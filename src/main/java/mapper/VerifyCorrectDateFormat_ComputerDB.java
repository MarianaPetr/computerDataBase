...
public class VerifyCorrectDateFormat_ComputerDB extends JUnitStories {
	 
		public VerifyCorrectDateFormat_ComputerDB() {
			super();
		...
		protected List<String> storyPaths() {
			return Arrays.asList("stories/VerifyCorrectDateFormat_ComputerDB.story");
		}
