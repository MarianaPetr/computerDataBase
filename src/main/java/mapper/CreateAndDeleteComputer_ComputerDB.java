...
public class CreateAndDeleteComputer_ComputerDB extends JUnitStories {
	 
		public CreateAndDeleteComputer_ComputerDB() {
			super();
		...
		protected List<String> storyPaths() {
			return Arrays.asList("stories/CreateAndDeleteComputer_ComputerDB.story");
		}
