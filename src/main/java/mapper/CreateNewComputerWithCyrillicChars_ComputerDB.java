...
public class CreateNewComputerWithCyrillicChars_ComputerDB extends JUnitStories {
	 
		public CreateNewComputerWithCyrillicChars_ComputerDB() {
			super();
		...
		protected List<String> storyPaths() {
			return Arrays.asList("stories/CreateNewComputerWithCyrillicChars_ComputerDB.story");
		}
