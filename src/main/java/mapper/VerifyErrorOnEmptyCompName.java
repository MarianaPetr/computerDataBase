...
public class VerifyErrorOnEmptyCompName extends JUnitStories {
	 
		public VerifyErrorOnEmptyCompName() {
			super();
		...
		protected List<String> storyPaths() {
			return Arrays.asList("stories/VerifyErrorOnEmptyCompName.story");
		}
