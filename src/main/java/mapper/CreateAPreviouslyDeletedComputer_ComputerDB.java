...
public class CreateAPreviouslyDeletedComputer_ComputerDB extends JUnitStories {
	 
		public CreateAPreviouslyDeletedComputer_ComputerDB() {
			super();
		...
		protected List<String> storyPaths() {
			return Arrays.asList("stories/CreateAPreviouslyDeletedComputer_ComputerDB.story");
		}
