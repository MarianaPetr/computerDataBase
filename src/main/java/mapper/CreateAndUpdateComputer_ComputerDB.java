...
public class CreateAndUpdateComputer_ComputerDB extends JUnitStories {
	 
		public CreateAndUpdateComputer_ComputerDB() {
			super();
		...
		protected List<String> storyPaths() {
			return Arrays.asList("stories/CreateAndUpdateComputer_ComputerDB.story");
		}
