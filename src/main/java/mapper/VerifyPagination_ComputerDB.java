...
public class VerifyPagination_ComputerDB extends JUnitStories {
	 
		public VerifyPagination_ComputerDB() {
			super();
		...
		protected List<String> storyPaths() {
			return Arrays.asList("stories/VerifyPagination_ComputerDB.story");
		}
