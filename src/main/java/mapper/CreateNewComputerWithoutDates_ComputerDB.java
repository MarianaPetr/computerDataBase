...
public class CreateNewComputerWithoutDates_ComputerDB extends JUnitStories {
	 
		public CreateNewComputerWithoutDates_ComputerDB() {
			super();
		...
		protected List<String> storyPaths() {
			return Arrays.asList("stories/CreateNewComputerWithoutDates_ComputerDB.story");
		}
