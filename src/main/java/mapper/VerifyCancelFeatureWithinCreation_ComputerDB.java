...
public class VerifyCancelFeatureWithinCreation_ComputerDB extends JUnitStories {
	 
		public VerifyCancelFeatureWithinCreation_ComputerDB() {
			super();
		...
		protected List<String> storyPaths() {
			return Arrays.asList("stories/VerifyCancelFeatureWithinCreation_ComputerDB.story");
		}
