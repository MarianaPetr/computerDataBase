...
public class CreateNewComputer_ComputerDB extends JUnitStories {
	 
		public CreateNewComputer_ComputerDB() {
			super();
		...
		protected List<String> storyPaths() {
			return Arrays.asList("stories/CreateNewComputer_ComputerDB.story");
		}
